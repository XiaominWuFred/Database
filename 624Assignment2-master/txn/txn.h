...
class Txn {
 ...
 protected:
  ...
  //added function for check write set' overlapping with otherwriteset
  void CheckWriteSet(set<Key> otherWriteset, bool* result);

  //added function for check read set' overlapping with otherwriteset
  void CheckReadSet(set<Key> otherWriteset, bool *result);
};
